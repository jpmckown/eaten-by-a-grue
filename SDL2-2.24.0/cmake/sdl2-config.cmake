...
set(eaten_by_a_grue_LIBRARY    SDL2::eaten_by_a_grue)
...
set(_eaten_by_a_grue_library "${SDL2_LIBDIR}/eaten_by_a_grue.lib")
if(EXISTS "${_eaten_by_a_grue_library}")
    if(NOT TARGET SDL2::eaten_by_a_grue)
        add_library(SDL2::eaten_by_a_grue STATIC IMPORTED)
        set_target_properties(SDL2::eaten_by_a_grue
            PROPERTIES
                INTERFACE_INCLUDE_DIRECTORIES "${SDL2_INCLUDE_DIRS}"
                IMPORTED_LOCATION "${_eaten_by_a_grue_library}"
        )
    endif()
    set(SDL2_eaten_by_a_grue_FOUND TRUE)
else()
    set(SDL2_SDL2_FOUND FALSE)
endif()
unset(_eaten_by_a_grue_library)
